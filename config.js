...
module.exports = {
    ...
    SESSION_ID: process.env.SESSION_ID || '07_14_H_E_R_M_I_T_UO4WONC',
    ...
    BOT_INFO: process.env.BOT_INFO || 'Johan;Liebert;243981564138;https://i.imgur.com/6oRG106.jpeg',

    AUDIO_DATA: process.env.AUDIO_DATA === undefined ? 'ʜᴇʀᴍɪᴛ;ᴀᴅɪᴛʜyᴀɴ;https://i.imgur.com/fj2WE83.jpeg' : process.env.AUDIO_DATA,

    STICKER_DATA: process.env.STICKER_DATA === undefined ? 'JOHAN LIEBERT;Rodrick' : process.env.STICKER_DATA,
